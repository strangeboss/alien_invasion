#!/usr/bin/python3
# -*- coding: utf-8 -*-
# Created by: python.exe -m py2exe hello_world.py -W setup.py
...
hello_world = Target(
    ...
    script="hello_world.py", # path of the main script

    # Allows to specify the basename of the executable, if different from 'hello_world'
    # dest_base = "hello_world",

    # Icon resources:[(resource_id, path to .ico file), ...]
    # icon_resources=[(1, r"hello_world.ico")]

    other_resources = [(RT_MANIFEST, 1, (manifest_template % dict(prog="hello_world", level="asInvoker")).encode("utf-8")),
