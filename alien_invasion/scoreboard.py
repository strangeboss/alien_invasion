...
class Scoreboard():
	...
	def show_score(self):
		#在屏幕上显示得分
		self.screen.blit(self.score_image,self.score_rect)  #blit(source,dest,area=None,special_flag=0) ->Rect
	...
	def prep_high_score(self):
		...
		self.high_score_image = self.font.render(("Hight Score:"+ high_score_str),
